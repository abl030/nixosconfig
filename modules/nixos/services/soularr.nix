...
# Not in nixpkgs — built inline. slskd-api (PyPI) also built inline.
{
  ...
  configTemplate = pkgs.writeText "soularr-config.ini" ''
    ...
    # PRODUCTION: allowed_filetypes = flac 24/192,flac 24/96,flac 24/48,flac 16/44.1,flac,alac,mp3 320,mp3 v0,aac 256+,ogg 256+,opus 192+
    allowed_filetypes = mp3,mp3 v0,mp3 320,ogg,opus,aac
    ignored_users =
