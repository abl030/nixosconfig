...
in {
  ...
  config = lib.mkIf cfg.enable {
    ...
    # No monitoring, by design: an ephemeral GPU appliance that the prom
    # hookscript shuts down whenever a gaming VM wants the card, and whose
    # vhost the tailnet ACL keeps off tag:server ("no Kuma"). Nothing to page.
