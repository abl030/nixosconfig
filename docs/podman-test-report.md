...
## Resume: 2026-01-21T16:46:20+08:00
DATA_ROOT=/home/abl030/podman-data
TIMEOUT_S=180

Testing docker/atuin
4d3ea6dab4a024e6fa93896df193bab0677bb8f35e869ddfb538e90546eb6bb8
6c1bd0028bed20b7aaed2dc6db2067284e7019501372bd941ca0b20ce335151b
940ff7f6a618e14f1462c12566949908e0b95b64fc1c65807ac0a390b3718708
atuin_postgresql_1
atuin_atuin_1
...
c60999aec40cd92cbe3b93502d409513e6817fb4cfc6e29421522a355d2fc58e
...
d545be6d56871ec695a86741c5e17eb7639851b6b5006de6759e001b61040717
audiobookshelf
...
Fetched 9863 kB in 1s (8990 kB/s)
...
Fetched 37.1 MB in 1s (41.4 MB/s)
...
a00fa506261bcd132e83859ff5981e826818444a0f3671b1c23ace04657f3c14
c18652eb51390252449a871735ea9f28873cad32bbed7c91c8bcce00215394bc
...
Writing manifest to image destination
43c5a5a89f13138c5b7f326dd2387763d36fa404e2feba6f224c884adc36fa7d
916f193aad2f89395959c0cee01d3520758e0ec732542babba1c8961b0b370c0
domain-monitor-db
domain-monitor-app
...
Traceback (most recent call last):
  File "/nix/store/l4svg7s9n7f3zzlfc05bv10bc67lrb07-podman-compose-1.5.0/bin/.podman-compose-wrapped", line 9, in <module>
    sys.exit(main())
             ~~~~^^
  File "/nix/store/l4svg7s9n7f3zzlfc05bv10bc67lrb07-podman-compose-1.5.0/lib/python3.13/site-packages/podman_compose.py", line 4256, in main
    asyncio.run(async_main())
    ~~~~~~~~~~~^^^^^^^^^^^^^^
  File "/nix/store/qzc04a3npl70cyyy6flnnrb2ig3kayxm-python3-3.13.11/lib/python3.13/asyncio/runners.py", line 195, in run
    return runner.run(main)
           ~~~~~~~~~~^^^^^^
  File "/nix/store/qzc04a3npl70cyyy6flnnrb2ig3kayxm-python3-3.13.11/lib/python3.13/asyncio/runners.py", line 118, in run
    return self._loop.run_until_complete(task)
           ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^^^^^^
  File "/nix/store/qzc04a3npl70cyyy6flnnrb2ig3kayxm-python3-3.13.11/lib/python3.13/asyncio/base_events.py", line 725, in run_until_complete
    return future.result()
           ~~~~~~~~~~~~~^^
  File "/nix/store/l4svg7s9n7f3zzlfc05bv10bc67lrb07-podman-compose-1.5.0/lib/python3.13/site-packages/podman_compose.py", line 4252, in async_main
    await podman_compose.run()
  File "/nix/store/l4svg7s9n7f3zzlfc05bv10bc67lrb07-podman-compose-1.5.0/lib/python3.13/site-packages/podman_compose.py", line 2070, in run
    self._parse_compose_file()
    ~~~~~~~~~~~~~~~~~~~~~~~~^^
  File "/nix/store/l4svg7s9n7f3zzlfc05bv10bc67lrb07-podman-compose-1.5.0/lib/python3.13/site-packages/podman_compose.py", line 2277, in _parse_compose_file
    content = rec_subs(content, self.environ)
  File "/nix/store/l4svg7s9n7f3zzlfc05bv10bc67lrb07-podman-compose-1.5.0/lib/python3.13/site-packages/podman_compose.py", line 293, in rec_subs
    value = {rec_subs(k, subs_dict): rec_subs(v, subs_dict) for k, v in value.items()}
                                     ~~~~~~~~^^^^^^^^^^^^^^
  File "/nix/store/l4svg7s9n7f3zzlfc05bv10bc67lrb07-podman-compose-1.5.0/lib/python3.13/site-packages/podman_compose.py", line 293, in rec_subs
    value = {rec_subs(k, subs_dict): rec_subs(v, subs_dict) for k, v in value.items()}
                                     ~~~~~~~~^^^^^^^^^^^^^^
  File "/nix/store/l4svg7s9n7f3zzlfc05bv10bc67lrb07-podman-compose-1.5.0/lib/python3.13/site-packages/podman_compose.py", line 290, in rec_subs
    svc_envs = rec_subs(svc_envs, subs_dict)
  File "/nix/store/l4svg7s9n7f3zzlfc05bv10bc67lrb07-podman-compose-1.5.0/lib/python3.13/site-packages/podman_compose.py", line 293, in rec_subs
    value = {rec_subs(k, subs_dict): rec_subs(v, subs_dict) for k, v in value.items()}
                                     ~~~~~~~~^^^^^^^^^^^^^^
  File "/nix/store/l4svg7s9n7f3zzlfc05bv10bc67lrb07-podman-compose-1.5.0/lib/python3.13/site-packages/podman_compose.py", line 309, in rec_subs
    value = var_re.sub(convert, value)
  File "/nix/store/l4svg7s9n7f3zzlfc05bv10bc67lrb07-podman-compose-1.5.0/lib/python3.13/site-packages/podman_compose.py", line 306, in convert
    raise RuntimeError(m.group("err"))
RuntimeError
FAIL(1): docker/graylog

----

Testing docker/immich
b5beda9597c97b4b3879e3a066e9bec1be739bcbf5744151f8e6b8e49ad5afcb
...
Writing manifest to image destination
c0f5a62cd389d2e2cb355f1c8ac9f4273ae8fdcf69dec9be21292a1210a8b5d9
...
Writing manifest to image destination
7fcd0214ee37aa79b61387e1551dbb9362a7a97ccc885635263d40a638384899
...
Writing manifest to image destination
772a7857f9625ff89bc737ec95ce6a05de83eee54a48b525a7aabf49ac266465
...
Writing manifest to image destination
5529b7fab6ed8cd3b6b4316ef705274a4ff4580699b304f689a2763eff65bbdc
Trying to pull docker.io/tailscale/tailscale:stable...

## Resume: 2026-01-21T16:48:36+08:00
DATA_ROOT=/home/abl030/podman-data
TIMEOUT_S=180

SKIP: docker/atuin (already in report)

----

SKIP: docker/audiobookshelf (already in report)

----

SKIP: docker/domain-monitor (already in report)

----

SKIP: docker/graylog (already in report)
...
Writing manifest to image destination
58727f7a69c5de387f083c41e318c22ab8771c1af8253ca45f4cf8a3d5312762
Trying to pull ghcr.io/caddybuilds/caddy-cloudflare:latest...
Copying config sha256:18e84ebd706296e277f93392bfb615d6acbd00b625f6fb4545ce3cffd2bb9752
Writing manifest to image destination
Error: creating container storage: the container name "immich_tailscale_sidecar" is already in use by 58727f7a69c5de387f083c41e318c22ab8771c1af8253ca45f4cf8a3d5312762. You have to remove that container to be able to reuse that name: that name is already in use, or use --replace to instruct Podman to do so.
Trying to pull ghcr.io/caddybuilds/caddy-cloudflare:latest...
Getting image source signatures
Getting image source signatures
...
Copying config sha256:778f44065ec5056309b21f87fe92b11f0d67476e0c7356b20fcf3873b040cf30
Writing manifest to image destination
6cda393fee9d5cc51ef6b25e127868c1bee40a99829b9f9743d01109b28b5f8e
Trying to pull ghcr.io/immich-app/immich-server:release...
Error: creating container storage: the container name "immich-caddy" is already in use by 6cda393fee9d5cc51ef6b25e127868c1bee40a99829b9f9743d01109b28b5f8e. You have to remove that container to be able to reuse that name: that name is already in use, or use --replace to instruct Podman to do so.
Trying to pull ghcr.io/immich-app/immich-server:release...
Getting image source signatures
Getting image source signatures
...
Copying config sha256:85364cd21cda9f531c5245abd1ced28f7c8bdda1c8e62d5ea2601ddcb468e5c3
Writing manifest to image destination
ee84206c32a401c26bb20077f09aaef22b04791ca140ffab300ebf3d63501a78
Error: creating container storage: the container name "immich-server" is already in use by ee84206c32a401c26bb20077f09aaef22b04791ca140ffab300ebf3d63501a78. You have to remove that container to be able to reuse that name: that name is already in use, or use --replace to instruct Podman to do so.
...
fb4bb0305e6b41b30503919126c9905fe544e658fe4214b9a5c65ca7df4d6bd9
...
Writing manifest to image destination
add489c22d4e37183f0bc34b568c41fba5ec5c4d33e9041acf1035fd514e0fe2
...
Writing manifest to image destination
79a416d11d69eb649d5ac687f3f04b541f9beb2ef3bcc85ff7e50a97f3da1a20
inotify-sender
autoheal
No containers running for project: sender_unraid
--- logs: inotify-sender (add489c22d4e) status=stopped ---
/sender.sh: /sender.sh: Is a directory
/sender.sh: /sender.sh: Is a directory
/sender.sh: /sender.sh: Is a directory
/sender.sh: /sender.sh: Is a directory
/sender.sh: /sender.sh: Is a directory
...
/sender.sh: /sender.sh: Is a directory
/sender.sh: /sender.sh: Is a directory
--- logs: autoheal (79a416d11d69) status=stopped ---
AUTOHEAL_CONTAINER_LABEL=autoheal
AUTOHEAL_START_PERIOD=120
AUTOHEAL_INTERVAL=30
AUTOHEAL_DEFAULT_STOP_TIMEOUT=10
AUTOHEAL_ONLY_MONITOR_RUNNING=false
unix socket is currently not available
AUTOHEAL_CONTAINER_LABEL=autoheal
AUTOHEAL_START_PERIOD=120
AUTOHEAL_INTERVAL=30
AUTOHEAL_DEFAULT_STOP_TIMEOUT=10
...
AUTOHEAL_ONLY_MONITOR_RUNNING=false
unix socket is currently not available
FAIL(1): docker/inotify/sender_unraid

----

Testing docker/invoices
c94fc87ac08c9ee21ef7e61f510c5ac9066364ffee4414585d26d1c6b8539f82
c6b0660f8347e2feaa7b0e343ce93065a0187a194dc9a288d3a6839a7369da97
...
Writing manifest to image destination
68b01369850bcdd03d2b278313ff7e937617618137c36669c10f14c5d188ff25
...
Writing manifest to image destination
00bc31d86d0d0f195152233c3df36cb89471e36a48771ba0e10979ff93cd6946
f9d625ece9f6c35e333dcd9e885bec720550fe0e827c131ad4bc4b8f2fc63fb3
...
Writing manifest to image destination
b440fe9d70049de853885d66a61498a4e4005c772c8e8fa86aea25d6ab8bfa6c
...
Copying config sha256:18e84ebd706296e277f93392bfb615d6acbd00b625f6fb4545ce3cffd2bb9752
Writing manifest to image destination
5a398712ab10cec31042638e433af2578bc6c471338ac91590b82526883212c9
...
Writing manifest to image destination
c01f94672d8482116c78287f679324b5c02e14e44aea9e1e53c2313ee706213f
...
Writing manifest to image destination
c802dd5c98bc9dc293d5014976a1d7b349df389c49a78180a534bd75b76fb190
...
Writing manifest to image destination
a5ec1064930bbbb235728eec67f98f5b955bfd38414262278d2cbcf7f7a573d9
...
Writing manifest to image destination
ed6c30021aec5f067347b2d3a4c73424e1474e91160bf2a48288590279602d77
...
Writing manifest to image destination
42d397564d626c39f0e9485ef9f7d5c27411eaa0abd60314f653870b05626be4
Trying to pull docker.io/library/docker.io/library/alpine:3.20...
Error: unable to copy from source docker://library/docker.io/library/alpine:3.20: initializing source docker://library/docker.io/library/alpine:3.20: reading manifest 3.20 in docker.io/library/docker.io/library/alpine: requested access to the resource is denied
243dc43563965d4fe35a9cf0c63ab403a6cf8a42877eda4fb437552f7228eece
...
Error: no container with name or ID "firefly_iii_cron" found: no such container
caddy-invoices
FAIL(124): docker/invoices

----

Testing docker/jdownloader2
1a271cdc60ee9625ad0daf916adca3fb0881ec9d0ba547cd70a7a69b776ab2f2
...
Writing manifest to image destination
ee7421369ef74bcade183a6d9501e2b27bf49deeff1912774005bc47ef0a0a0f
jdownloader-2
...
81885acc1a4898e28971cca6d62305e0c935c7486d35fdcf10a022c8caf1e38d
fe653247ce9b399f980282d10abfda0f17c8183d32529388ad1052b9b9c62c62
Trying to pull docker.io/library/docker.io/library/postgres:15.2...
Error: unable to copy from source docker://library/docker.io/library/postgres:15.2: initializing source docker://library/docker.io/library/postgres:15.2: reading manifest 15.2 in docker.io/library/docker.io/library/postgres: requested access to the resource is denied
...
Writing manifest to image destination
23fc77928ec7dfc9a8454d93fac5d0ad629aaf5404f9c1a42553445b61920005
c3818e8923df2ba4a13a77fbfd08476efd8b49563cdf3fc678681ec9edd24fd1
9497c336b750bb0ba84e75372f7790fc708c5dfc9cf40eac3b2eb043eaf1e478
...
Copying blob sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1
time="2026-01-21T16:53:40+08:00" level=error msg="While recovering from a failure (applying layer diff), error deleting layer \"1201de400a6418d94c4a5e2f1035227ecc1a5700af4694d679531ccc5ed0e8bc\": creating temp directory failed: mkdir /home/abl030/.local/share/containers/storage/overlay-layers/tmp/temp-dir-3356608180: no space left on device"
Error: unable to copy from source docker://ghcr.io/arabcoders/watchstate:latest: copying system image from manifest list: writing blob: adding layer with blob "sha256:23cb281faa1439bdb1c3fc8f61093ff343afc33038426ec06bb4e2fd7e3f90b8"/""/"sha256:edbc980c5cdcc465e57a3e3184bc39f8e7ca9aef6441db77536d115e86e47554": unpacking failed (error: exit status 1; output: write /usr/bin/ffmpeg: no space left on device)
...
Error: unable to copy from source docker://cyfershepard/jellystat:latest: copying system image from manifest list: writing blob: storing blob to file "/var/tmp/container_images_storage3894453587/8": write /var/tmp/container_images_storage3894453587/8: no space left on device
...
Writing manifest to image destination
12a22c1d15e66164b6ca3a9652d0ab573b5ea52f0563220ca98c4bed767bc105
jellyfin_network_holder
Error: no container with name or ID "jellystat-db" found: no such container
jellyfin
jellyfin-tailscale-sidecar
jellyfin-caddy
Error: no container with name or ID "watchstate" found: no such container
FAIL(124): docker/jellyfinn

----

Testing docker/kopia
5bd7938ecd16a6676959c5bd677882032495674633150ae9afddd2f6f89ab547
Trying to pull docker.io/kopia/kopia:latest...
Getting image source signatures
Copying blob sha256:e195de4fb795e1d2b3f8a5a436a3cbadcd53534675d620cf229934fcfd89a7f3
Copying blob sha256:7e49dc6156b0b532730614d83a65ae5e7ce61e966b0498703d333b4d03505e4f
Copying blob sha256:291e3eb86051a6b5fa6389429568284d2353d388c1f2c36b70d74bedd9ec56b0
Copying blob sha256:2494112293f57caa5ed86dbbeba4268bec9cf2936793e38d241852aee9dde607
Copying blob sha256:103db213145e8c8986855bb66bc1cd59414fe6e00851485fc78dddccda70840d
Copying config sha256:b9cab8f06fc2755a04cb9a7fd07513a3638863be312ff059821a12df728e0ac8
Writing manifest to image destination
d8a3e5a8ae6b95631a327af24662ef9e4461fc8095715dcd366ddd0df218dcb3
59cce1c4ef5ff254671a1620c287e06b9e5593731bfe6804b9eeda2aeadd316c
kopiaphotos
kopiamum
OK: kopia (kopiaphotos kopiamum)
PASS: docker/kopia

----

Testing docker/management
d06393a794373a3594962a80847b9da4fb1ef4fab5f40a46155c712b73d0ddea
88da2a6a9899c09c5bb824df1ac982434ab6cf68f3730baf51ad8d45c72a239a
...
Writing manifest to image destination
d4a7e7dc3b16b0a0b6cc3c0aee8bbdfc95aeac54d0a53646965eed800257277e
Trying to pull docker.io/gotify/server:latest...
time="2026-01-21T16:57:14+08:00" level=warning msg="Failed, retrying in 1s ... (1/3). Error: copying system image from manifest list: determining manifest MIME type for docker://gotify/server:latest: reading manifest sha256:0fc115bb669661f11c71f794a33d43c7e17d7b8366d8e8a4b6fe70427c4bbe29 in docker.io/gotify/server: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T16:57:59+08:00" level=warning msg="Failed, retrying in 1s ... (2/3). Error: copying system image from manifest list: determining manifest MIME type for docker://gotify/server:latest: reading manifest sha256:0fc115bb669661f11c71f794a33d43c7e17d7b8366d8e8a4b6fe70427c4bbe29 in docker.io/gotify/server: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T16:58:35+08:00" level=warning msg="Failed, retrying in 1s ... (3/3). Error: initializing source docker://gotify/server:latest: reading manifest latest in docker.io/gotify/server: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
Error: unable to copy from source docker://gotify/server:latest: initializing source docker://gotify/server:latest: reading manifest latest in docker.io/gotify/server: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit
autoheal
management_dozzle_1
Error: no container with name or ID "management_gotify_1" found: no such container
FAIL(125): docker/management

----

Testing docker/management/epi_management
fe01758ba8ac91a071f5b434dba973fb3297118930c662718e6b905c08ebd8d3
aae8ba45ce6bfb6c0e7f54f6e4207ef1a05aeb2229eb550ff28e3179d0449540
fabe9f86f5b86188b26a70daa4a943ad18cdb739e7b88aacb8ed0be164b6c497
autoheal
dozzle-agent
No containers running for project: epi_management
--- logs: autoheal (aae8ba45ce6b) status=stopped ---
...
AUTOHEAL_ONLY_MONITOR_RUNNING=false
unix socket is currently not available
--- logs: dozzle-agent (fabe9f86f5b8) status=stopped ---
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:15Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:15Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:16Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:17Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:17Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:18Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:19Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:19Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:20Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:20Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:21Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:21Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:22Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:22Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:22Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:23Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:24Z","message":"Failed to run command"}
FAIL(1): docker/management/epi_management

----

Testing docker/management/igpu
b2fefdd1b1131a9ddd6d5d1a10d3de8d30c976f5574894394169df525da49961
8fbf97569988c771363c572c8d5cb9bc801af047fa77bc2ead80309a8e6f1603
f1d4c21741eb352459a13e08a5f329c10d6a961b46849b47bd00e2c67ba68214
autoheal
dozzle-agent
No containers running for project: igpu
--- logs: autoheal (8fbf97569988) status=stopped ---
AUTOHEAL_CONTAINER_LABEL=all
AUTOHEAL_START_PERIOD=0
AUTOHEAL_INTERVAL=30
AUTOHEAL_DEFAULT_STOP_TIMEOUT=10
...
AUTOHEAL_ONLY_MONITOR_RUNNING=false
unix socket is currently not available
--- logs: dozzle-agent (f1d4c21741eb) status=stopped ---
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:26Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:26Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:27Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:27Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:28Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:29Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:29Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:30Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:30Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:31Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:31Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:31Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:32Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:32Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:33Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:33Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:34Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:34Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:35Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:35Z","message":"Failed to run command"}
{"level":"fatal","version":"v9.0.2","error":"failed to create docker client: Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?","time":"2026-01-21T08:59:36Z","message":"Failed to run command"}
FAIL(1): docker/management/igpu

----

Testing docker/mealie
dc9e37157d34d54db7d216c4d80e5493143f1cdd1c3ccfd0776adf4a3e0a6e71
Trying to pull docker.io/library/postgres:15...
time="2026-01-21T17:00:16+08:00" level=warning msg="Failed, retrying in 1s ... (1/3). Error: copying system image from manifest list: determining manifest MIME type for docker://postgres:15: reading manifest sha256:f83bd1dbb23440bd01b6a0d89cdad21a50c15a5bb4a25543aa2141e2a5c8cd78 in docker.io/library/postgres: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:00:53+08:00" level=warning msg="Failed, retrying in 1s ... (2/3). Error: initializing source docker://postgres:15: reading manifest 15 in docker.io/library/postgres: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:01:29+08:00" level=warning msg="Failed, retrying in 1s ... (3/3). Error: initializing source docker://postgres:15: reading manifest 15 in docker.io/library/postgres: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
FAIL(124): docker/mealie

----

Testing docker/music
ec29b0e3a88dd9d007b99199ef36b1786698f8b89af7e7267ac5162df731814f
025c412e35003047716f58c9cf404968306c3e2be380928196b3b6781f998f78
Trying to pull lscr.io/linuxserver/lidarr:latest...
Getting image source signatures
Copying blob sha256:8e3243413165157cdbfd2bf5bbeccd876db90735fbfcd0346eacc55ab92a1270
Copying blob sha256:f6a4c3e338ed76d3e90c1ce7a15013a45c9b55febc952bc905eed245ce0bb8d2
Copying blob sha256:f5b42728987c5b08e8f6c5140e4b2bebf142af452a45227d19cbcf2f5d4bdbdf
Copying blob sha256:bb02b75e6c26e6d9cdbde965fce3e2b925e130760a18d363af414b03969f17ea
Copying blob sha256:ab61b7239f0de11fa333bec3863244fd23c3e1360e2b1180abf639188e55cf3a
Copying blob sha256:2f0034ccc3b82967382b65874f0565cf96cfc0e36c3cf5ab6a7bb70c9990cfdb
Copying blob sha256:820417b508d8a6a5203bf0e04ab1ded91cb8c96336a85e6b4c6be8c14bf12a24
Copying blob sha256:52df5be8743a97b08fa80a8cff29b66ba77486333086d485de7a24c441941206
Copying blob sha256:8b44946c179d479c2919689f069d7184d112e8d6ad778691d5e7e4e5f299bd9d
Copying config sha256:9417a9ecbf0ac20ccd02bb607ed022e2d4d870dd8dc11341ed80cd4baa4a0b26
Writing manifest to image destination
e177965a1ad64d68d4bff395789bc00d64223326e1a613c3c3b88f24b1d74c50
fde4dfa4b3cd1ca0449ad868412df4e54f0fa76c04662f2f85491233dd6ea3fe
Trying to pull docker.io/filebrowser/filebrowser:v2...
time="2026-01-21T17:03:22+08:00" level=warning msg="Failed, retrying in 1s ... (1/3). Error: initializing source docker://filebrowser/filebrowser:v2: reading manifest v2 in docker.io/filebrowser/filebrowser: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:03:59+08:00" level=warning msg="Failed, retrying in 1s ... (2/3). Error: initializing source docker://filebrowser/filebrowser:v2: reading manifest v2 in docker.io/filebrowser/filebrowser: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
Getting image source signatures
Copying blob sha256:fe963d3ce04d45d02ebfe9657fc6e4668f69b27d5accdb60f91cbeef3984be43
Copying blob sha256:9807aeb3e8698b920a86cd754a61d5f7e6865ca1f46542592a61dbfe2e8a20b6
Copying blob sha256:6d40c172fb8ac79c87e61c9d70255a1d46ae0fa76753545941c37bb547457a01
Copying blob sha256:c418ea066979133bb326c5c8cae28be255fa2ee3b8046ed472a0f09c8f906302
Copying blob sha256:1bf1d6bd2d21011e60bcaa7526e1a58f89d4153f30848d2d3768cccbb40f7361
Copying blob sha256:febd17b4322e5ebc82ffaad6bb8cc14fc6db8ecd72118e58d88408e514b1ce40
Copying blob sha256:a0ea3b03ab6654dd3ba1956d885e35701e5d83c131024e05cd9740d784c69319
Copying blob sha256:766287a169346c03e4c39492d20077a9b865e07874945c794fe59fd63c2e273a
Copying blob sha256:ba8a48f32a609be71b6f0b4432e248931d302c9740e5c6f63d31982a6957f74e
Copying blob sha256:5619efefd39c4457c99274a90d22da04cf0aaa0cbc9fd5ae98c06b953f51644a
Copying blob sha256:d19f61721ef5b487e650bd2adc295c2ad3e146ed116b872e2d666b1d5ddd7056
Copying blob sha256:b0b6e941c4c8f4e8743889787a54008d2cb85d1ce3431f5def979c6c2596de14
Copying config sha256:8f90cf03b905d101dcc177817c25602503068ba26905840bdbd3af2c84346112
Writing manifest to image destination
c91ef52cd77fa0cd8a832a0e2b53d658d9c3b1784b5b72780b2199c56939992a
74c4adc87a4ad655f178630095fca26dd4220b00fd62e325054c5d567d8258e3
ab952ba0269bb0a4d3f907dd37461ad97f69eee52f8e3f470c8833df08587528
Trying to pull lscr.io/linuxserver/ombi:latest...
Getting image source signatures
Copying blob sha256:5eb77ae989566994a643724e14bc017f2be93635fad43385738c0bbbad3fb61d
Copying blob sha256:f6a4c3e338ed76d3e90c1ce7a15013a45c9b55febc952bc905eed245ce0bb8d2
Copying blob sha256:fa320a8bcf119de3101acff4bb53940eeb6753fe0979274cb29edd513ee5dfc5
...
Copying blob sha256:ead2c5851e51c822165ad2655efb2d37b1575423079539880b7de8abeee4a897
Copying blob sha256:744073494f37a3d2c835acc06b1621f3ac74bf9f358492efa8ce3e41678b4491
Copying blob sha256:3bddbd5ed304e5b96c84cdd547f51a402d01912f0caa270917eac5684f243a55
Copying blob sha256:73eb55fcfd62f1f8df85736e76967b1629a15e084653e56baac015fc72275e02
Copying config sha256:a3ea8e3d97e96f7584ac614667d5ee28c1434749de0036b1a5b78fed9379e350
Writing manifest to image destination
e9fc0330f71ae585bef399fb621a81ce5e6d5374bcf6700898931e8eb2966f58
music_network_holder
lidarr
ombi-db
music-filebrowser
music-tailscale-sidecar
music-caddy
Testing docker/StirlingPDF
ombi
53be522a4a5f583d30ecc238a1a76a9e4fd5bf23ed6b23f463036d057d641c47
Trying to pull docker.stirlingpdf.com/stirlingtools/stirling-pdf:latest...
Getting image source signatures
Copying blob sha256:26b554f1ec93d61e6e0e8b0d361e20a61efc79bf154f7171f5d6bd2cf37aea23
Copying blob sha256:553ba30596d4c72d338bb0e5ad4c95d9d43c7557ce2b91596048733b25594457
Copying blob sha256:44b3e9705e743a9a5e2e3445e16d4b65032eecaf6e9906c6cf8333f029839f85
Copying blob sha256:99ad503ef6e0d19d1cf764303b631e21f789da18248d1fd91c1eb4257181ad5b
Copying blob sha256:a7d8f22c2aadf20d5854c39803f24d3546769c0e536552ff2c6e9ad3373e0c9c
Copying blob sha256:762e828c087b1fc4bb9fdc98ca28f5eecdecd533b263ebd9d70d7817f1861a26
Copying blob sha256:ac0459752ab8e615a907ccbce4ba7bf685e5284e6a0ffa7c798273e4c51dfa16
Copying blob sha256:69f9632ad30d96748d70ed91c26629762320cbedc0944c830937fe23c474941f
Copying blob sha256:cf8b57e760b89e3543127d89b28d9372dd6d155ec1e1b28ebb1a4a51453189da
Copying blob sha256:89b662b8791dcdb6a08fd966a5adc1f173502e94194922598f3a3ff740c233d8
Copying blob sha256:180b2ee30f5c23189514061fa97b0304c9a6d5bf2906f60f56cd8c42851c6729
Copying blob sha256:e6914dc3020187368f0d3b20952b1aa0a8fc607fa53554ddaf63444f57de06a2
Copying blob sha256:f9f3f1f0d2bf05255bfb39906a32fb9423aaff11bd0072550c27086df34876a2
Copying blob sha256:30189fc0f15550031149944c859e1fdde9c98fba41bfe5a3f4eefc6039569701
Copying blob sha256:ea43367470780ed7e39be5e981bd5f941ae30478940c9557bc195a8424a64344
OK: music (music_network_holder lidarr ombi-db music-filebrowser music-tailscale-sidecar music-caddy ombi)
Copying config sha256:7603be3fc666d347527a421ee4787764cc221eb27b64b5ac3defe0b52555deec
Writing manifest to image destination
baec8818f80f78004cf95a8ba8c5ba3a363369d1cd328f14d7dab22bd6024b7a
stirlingpdf_stirling-pdf_1
OK: stirlingpdf (stirlingpdf_stirling-pdf_1)
PASS: docker/StirlingPDF

----

Testing docker/WebDav
dd29fa0ccff3c059de0ae3ea05bad81530e1ae625870350421dabc7c1c3efd32
Trying to pull docker.io/ck98/webdav-nginx:latest...
Getting image source signatures
Copying blob sha256:40a676edb655111aa18af4be55b03385d3a6fd8e3c903cd1722e8a2c19497c41
Copying blob sha256:4cebab8a2e1680a1670c929fbe05041d7b8eae31be3f1ec78eaa6db451e9b07a
Copying blob sha256:cb7b8c3f45f393bedbeedc64b11ef466d241bdd60a61b70431b20dcda8a456a6
Copying blob sha256:231c12b2575669b34ae7115dfc21536dac9d0ebbe8706238a1c58f0e7d8a9dea
Copying blob sha256:35807b77a593c1147d13dc926a91dcc3015616ff7307cc30442c5a8e07546283
Copying blob sha256:5d3403a47b6169123fcf53a4465bd92f0e5122757867156a9cb24c59030e495c
Copying blob sha256:142bd4c07e487d9f0c39e8ac35eab2789dacb3996f59dbc87db7e4d1ff670790
Copying blob sha256:23508f93947c52fc5a80d880f789b19ba0e703d6d368545b487543c053ebdb6b
Copying blob sha256:fb301e69f5ef8abbb122213603cbb14d45456d54bcd497f50514bb53e360ffc2
Copying config sha256:352864edc006156e25ffae1b29349b288279fb4e259ea5590a47cb76627b4f7e
Writing manifest to image destination
091f13cdcb3142a29ea5fa5f138696f0a6b8a6ee052882a8c831ff24c51f5344
webdav
OK: webdav (webdav)
PASS: docker/WebDav
...
Testing docker/music

music_network_holder
lidarr
ombi-db
music-filebrowser
...
Testing docker/netboot
e588ab810ed882943130086170e56e0e3cf4689274ec6b3e9cafd1dae50530d0
Trying to pull ghcr.io/netbootxyz/netbootxyz:latest...
Getting image source signatures
Copying blob sha256:d3c696cb25915fcdbcc15f9aeaaab9d11eda2517cb1a2881079f37ee676aad6a
Copying blob sha256:2d35ebdb57d9971fea0cac1582aa78935adf8058b2cc32db163c98822e5dfa1b
Copying blob sha256:d2b3959dcc5fd63a5b11872e6ed279dee46fbb8914c18e0016b10919a43740dd
Copying blob sha256:d3952243eb1daca4361ae6c8f86c8cbe79efb3181b91085a4e204d8c7854ec2a
Copying blob sha256:3c9e71c612f42d78fd904f8daf97c3becd44365b30fa298b2d1a4e3f787209fc
Copying config sha256:0cb3e3c23467066ca7499d86edfe3c439e4ea6c861d8ab5536c69851a24ad457
Writing manifest to image destination
ad6031e34e9e9bb9e715ff51001a9c0f840feacb4533a768be449c0611600e9a
netbootxyz
OK: netboot (netbootxyz)
PASS: docker/netboot

----

Testing docker/nicotine
3a7a82cb66cb3c1d4553a5835e24d486418b5bcce4237e0ef07263aff3c2224d
Trying to pull ghcr.io/fletchto99/nicotine-plus-docker:latest...
Getting image source signatures
Copying blob sha256:d575c36c6b243e83e968ac62d23deb5a9d31c7fb3e6053148cf395ad02dd0a37
Copying blob sha256:c0f8eff906b8b4379c387842515be0c1cca71b1826474bd58a4f4e3018ed9b9c
Copying blob sha256:b7ae803eebc532791e487ca5122f9bf4d72382f8cd44c58f8661baf52ecb61c6
Copying blob sha256:f740d3047689b1ae78684b8c44b00e05dc105e8531a879c4f753d261a18cdaaa
Copying blob sha256:39457aef510accfdea3d420800eff60626686af28b3dab54fcf891aad6bd0b09
Copying blob sha256:f9f13d3ace4ce46fdd8245da014aa3bc526bb4beac992002ed15184cc9d21dcb
Copying blob sha256:009887cfa0fd6ca99528583f9779e8eeff3170c04485a344cf3e56ddc6b53437
Copying blob sha256:b607bb444aab74c0e5a65b63125c248fe9596acbcd87673896aad34d5b4c6ae5
Copying blob sha256:694424f0bd991085269bda5106e9ceff1c554931a4b4ed01a8cc764d594cc3cc
Copying blob sha256:30e45ebb63cc439f001204198c708b930003fd5531c19c229636eef72bea7760
Copying blob sha256:d920f8f05f7e33fdfe86a8f48116afa5cc8e5ffbe115376c03fb0895d157bc7a
Copying blob sha256:ab1dd3ab63239f6bb13cfb6b5a0cc96aebbe5e395d705b308d5837f402c1a124
Copying blob sha256:13e867925307c5aa74494c8e5c4e56f83ac264f352d0b1ed7c1b4e10570051a7
Copying config sha256:afd75a5337ef1beb113f99dc9ac62d0bbe108be37abe639ae91654a4a1d2aa0a
Writing manifest to image destination
3af195ef3d618fa1edefbb59455d01014784d556c2719015319fe570caf5656e
nicotine-plus
OK: nicotine (nicotine-plus)
PASS: docker/nicotine

----

Testing docker/ollama
68116e150cb2a4f81d8d353bcd1cc490b057870db8cb22b6b52163217b69e97e
...
time="2026-01-21T17:08:03+08:00" level=error msg="While recovering from a failure (applying layer diff), error deleting layer \"dfbe7557cc88be5f932aff3a72c9ca2b8c46a93bc9d4b188a6a207a556fbf444\": creating temp directory failed: mkdir /home/abl030/.local/share/containers/storage/overlay/tempdirs/temp-dir-3329340410: no space left on device"
Error: unable to copy from source docker://ollama/ollama:latest: copying system image from manifest list: writing blob: adding layer with blob "sha256:853ef0b789db8fd7c6f8a2abf8ed05b37401947945ebbd7f7b7f9a8a2dda0773"/""/"sha256:7e8f6a3ad00cf1ceb92ca4f2f330dcdf5c936c34f8467345e6277c9aa29ee7fc": unpacking failed (error: exit status 1; output: write /usr/lib/ollama/cuda_v12/libcublasLt.so.12.8.4.1: no space left on device)
...
Copying blob sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1
time="2026-01-21T17:09:00+08:00" level=error msg="While recovering from a failure (applying layer diff), error deleting layer \"33d779a4384c78c4f25634a91ca38d0c3b3ce40c127665037141e10891e21a3f\": creating temp directory failed: mkdir /home/abl030/.local/share/containers/storage/overlay-layers/tmp/temp-dir-330289111: no space left on device"
Error: unable to copy from source docker://ghcr.io/open-webui/open-webui:main: copying system image from manifest list: writing blob: adding layer with blob "sha256:8c3f86abbe29e21b4703405f134dd1cc87e80e0f12a13a9c6066f0bab55051b0"/""/"sha256:40b3d0a8c36cd08d79b43af50df0213449b95ba8790b289c8eb32aef91649e47": unpacking failed (error: exit status 1; output: write /usr/local/lib/python3.11/site-packages/torch/distributed/fsdp/fully_sharded_data_parallel.py: no space left on device)
Error: no container with name or ID "ollama" found: no such container
time="2026-01-21T17:09:00+08:00" level=warning msg="Found incomplete layer \"33d779a4384c78c4f25634a91ca38d0c3b3ce40c127665037141e10891e21a3f\", deleting it"
Testing docker/ollama
97dd584f59db176e86ea5de54e0ad31d6b0fd2acce7f1f1ae8ed64bdce58d452
Trying to pull docker.io/ollama/ollama:latest...
Getting image source signatures
Copying blob sha256:853ef0b789db8fd7c6f8a2abf8ed05b37401947945ebbd7f7b7f9a8a2dda0773
Copying blob sha256:26f128d62ae6c1cc8193c1cbb128dbf96869435892e9e4e49740f32fe4b6e47b
Copying blob sha256:1e8c9570d8e095d43b6cfe021b9c5b0278b983067f61670376d66df1b4c6de71
Copying blob sha256:a3629ac5b9f4680dc2032439ff2354e73b06aecc2e68f0035a2d7c001c8b4114
time="2026-01-21T17:11:10+08:00" level=error msg="While recovering from a failure (applying layer diff), error deleting layer \"dfbe7557cc88be5f932aff3a72c9ca2b8c46a93bc9d4b188a6a207a556fbf444\": creating temp directory failed: mkdir /home/abl030/.local/share/containers/storage/overlay/tempdirs/temp-dir-1185688192: no space left on device"
Error: unable to copy from source docker://ollama/ollama:latest: copying system image from manifest list: writing blob: adding layer with blob "sha256:853ef0b789db8fd7c6f8a2abf8ed05b37401947945ebbd7f7b7f9a8a2dda0773"/""/"sha256:7e8f6a3ad00cf1ceb92ca4f2f330dcdf5c936c34f8467345e6277c9aa29ee7fc": unpacking failed (error: exit status 1; output: write /usr/lib/ollama/cuda_v12/libcublasLt.so.12.8.4.1: no space left on device)
Trying to pull ghcr.io/open-webui/open-webui:main...
Getting image source signatures
Copying blob sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1
...
Copying blob sha256:c5edc81cb7680763954962e5edbccff1c8e452b22017fea623ae33becd8bd6da
Copying blob sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1
time="2026-01-21T17:12:14+08:00" level=error msg="While recovering from a failure (applying layer diff), error deleting layer \"33d779a4384c78c4f25634a91ca38d0c3b3ce40c127665037141e10891e21a3f\": creating temp directory failed: mkdir /home/abl030/.local/share/containers/storage/overlay-layers/tmp/temp-dir-3039433906: no space left on device"
Error: unable to copy from source docker://ghcr.io/open-webui/open-webui:main: copying system image from manifest list: writing blob: adding layer with blob "sha256:8c3f86abbe29e21b4703405f134dd1cc87e80e0f12a13a9c6066f0bab55051b0"/""/"sha256:40b3d0a8c36cd08d79b43af50df0213449b95ba8790b289c8eb32aef91649e47": unpacking failed (error: exit status 1; output: write /usr/local/lib/python3.11/site-packages/torch/distributed/fsdp/fully_sharded_data_parallel.py: no space left on device)
Error: no container with name or ID "ollama" found: no such container
time="2026-01-21T17:12:14+08:00" level=warning msg="Found incomplete layer \"33d779a4384c78c4f25634a91ca38d0c3b3ce40c127665037141e10891e21a3f\", deleting it"
FAIL(124): docker/ollama

----

Testing docker/openobserve
1a78cb9e0fba137061b196a3f6fcc5f7150a21531d004fb99c8019d8b511cc44
Trying to pull public.ecr.aws/zinclabs/openobserve:latest-simd...
Getting image source signatures
Copying blob sha256:d557676654e572af3e3173c90e7874644207fda32cd87e9d3d66b5d7b98a7b21
Copying blob sha256:5b3013706a463509f05fabda3a5f854b1c5f3429561cf9374db6e6681da5493f
Copying blob sha256:0f8b424aa0b96c1c388a5fd4d90735604459256336853082afb61733438872b5
Copying blob sha256:9d2753d762cc58b055d94d102989775221df5156b7bec5861353454c308ad197
Copying blob sha256:7f3244d399e3aa6d6587c77141bdee7e70c96e127afb61e3c8c0efe8894553fc
Copying blob sha256:0ee2280d8e7936fbd96b856698cae107d52e357c013ef70912b29361e7b244a2
Copying blob sha256:d82bc7a76a838c9a4a6025192429c2fed58f73742ef1fb9c8bb7b995fc3b7213
Copying blob sha256:68e4cd60e60fed4486d5b4b40b079e57781e828d93d80a7411e8760dcccfbbf7
Copying blob sha256:0783a66ae7492bb16937c7723c534e431404aa3ebbdcaaed65d264a95a266b9e
Copying blob sha256:b40161cd83fc5d470d6abe50e87aa288481b6b89137012881d74187cfbf9f502
Copying blob sha256:411e1c946a02ee44c9adc542515ae29ff58d65149a4a201cbd688297c9900ee4
Copying blob sha256:77964957095d7872770920c8f55d28613e85f8e27aa0b157a440e0d635193fa9
Copying blob sha256:b610ff1658d2dbdc72fe51ff80e039fca6c679b75315f29bdc7dabc5b71c3644
Copying blob sha256:d7d1929570b82d94cbb7f837aeae72949809a88d4efe038b9b55a1bee9e1c31a
Copying blob sha256:6c174cbb5f6c30cdb6fdb1ede6465d9f750f412cc722f81d2c43992d739eddcb
Copying blob sha256:b62c759db193e3e169fc765b090b87fc148e6c05b555e4548d2cc081e7163dfc
Copying blob sha256:80a6d6970a059efc9d5a25a2d65794491ed1f136bf8fd6a2203f8b5e1245e7a4
Copying blob sha256:68f04394073ceed101bfbd3b6bcb9ce1a90ceec76d0d99e8247c615e02288692
Copying blob sha256:78269c9827a382786d68d1ea4586fbbe4798e5dccce62e18121bfd778e51ba63
Copying blob sha256:29e9d2040d07f299748fe4adb38fe610ac6cd1191782fc1a482e2ffb4725c072
Copying blob sha256:872e2327088e1e99f7bf16b8c907a2845efd3faf1c6e3d6d0a68e0d7cc8d4e51
Copying blob sha256:4223557c8803232fa7dc8e1e2bc48cf7f50c21ddf0e637e806c0e02fb10525c0
Copying blob sha256:0741b431313c3b3de0326d0bf31d16525973019323d969a7fc396926eba9fd04
Copying blob sha256:de8b5ccc4a04649a8cfe3811fd3392fdbb94a245d0b311868609189d0963fb11
Copying blob sha256:b6c87a53086793a1a35bc3d69634b7954637274e2238bbac83c211c9dcd41500
Copying config sha256:3c6360964da09520e51348e6bfe89ffd13f2228b76ac9ddf28ffc14716889f80
Writing manifest to image destination
2aecfdde71eca0d8df27c268386c34a4168a6ac56f0ebc36eab7682150ec6e8b
openobserve
No containers running for project: openobserve
--- logs: openobserve (2aecfdde71ec) status=running ---
FAIL(1): docker/openobserve

----

Testing docker/paperless
7dd0e6b54515db6cc900ffac1084bfb0a930a4c9fa00b87aa608e0891e06f12e
...
Writing manifest to image destination
04b15b89918921ea5ac279dbb14cb7b1914530d2d81804ddb1df7150c12508c8
...
Writing manifest to image destination
edf6f05a16deda39b14c06f2fb0e39400a6e7931059336ffd8b041d661a4b30d
...
Writing manifest to image destination
2a521cfca826452c88617f73b4eeea1a693267b0ac8c1629e250f8517b2efb3e
...
Writing manifest to image destination
faa15c74faa40a8d456ac7d8ed3705eabd01ebcc2f575cf282996fdbc70cf3b2
...
Error: unable to copy from source docker://ghcr.io/paperless-ngx/paperless-ngx:latest: copying system image from manifest list: writing blob: storing blob to file "/var/tmp/container_images_storage1400287008/8": write /var/tmp/container_images_storage1400287008/8: no space left on device
Trying to pull docker.io/icereed/paperless-gpt:latest...
time="2026-01-21T17:14:56+08:00" level=warning msg="Failed, retrying in 1s ... (1/3). Error: initializing source docker://icereed/paperless-gpt:latest: reading manifest latest in docker.io/icereed/paperless-gpt: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:15:33+08:00" level=warning msg="Failed, retrying in 1s ... (2/3). Error: initializing source docker://icereed/paperless-gpt:latest: reading manifest latest in docker.io/icereed/paperless-gpt: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:16:26+08:00" level=warning msg="Failed, retrying in 1s ... (3/3). Error: copying system image from manifest list: determining manifest MIME type for docker://icereed/paperless-gpt:latest: reading manifest sha256:b7b3c48f275e453f8a48d6466b4365fbdde12db4764262096d2242479a6865b4 in docker.io/icereed/paperless-gpt: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
FAIL(124): docker/paperless

----

Testing docker/paperless/paperlessai
149cd415fba2817140d262fdf6a7f47589790f391950a7fc550ef90ffb58019d
Trying to pull docker.io/clusterzx/paperless-ai:latest...
time="2026-01-21T17:17:12+08:00" level=warning msg="Failed, retrying in 1s ... (1/3). Error: initializing source docker://clusterzx/paperless-ai:latest: reading manifest latest in docker.io/clusterzx/paperless-ai: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:17:49+08:00" level=warning msg="Failed, retrying in 1s ... (2/3). Error: initializing source docker://clusterzx/paperless-ai:latest: reading manifest latest in docker.io/clusterzx/paperless-ai: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:18:42+08:00" level=warning msg="Failed, retrying in 1s ... (3/3). Error: copying system image from manifest list: determining manifest MIME type for docker://clusterzx/paperless-ai:latest: reading manifest sha256:19baad5ab2607d65087712fcb3ff74b6c5f7e840ea31061dace4d8ab1ef40a17 in docker.io/clusterzx/paperless-ai: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
Error: unable to copy from source docker://clusterzx/paperless-ai:latest: initializing source docker://clusterzx/paperless-ai:latest: reading manifest latest in docker.io/clusterzx/paperless-ai: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit
Error: no container with name or ID "paperless-ai" found: no such container
FAIL(125): docker/paperless/paperlessai

----

Testing docker/plex
1af9b38c7c176520e6947f06dda1e5bc33e49c584d211bf85bdc9a56f6a55e22
fec0c0fa0a926a7f17c30e4a388b46b917409393554272aa9f4aceca7c475dba
Trying to pull lscr.io/linuxserver/plex:latest...
Getting image source signatures
Copying blob sha256:5eb77ae989566994a643724e14bc017f2be93635fad43385738c0bbbad3fb61d
Copying blob sha256:f6a4c3e338ed76d3e90c1ce7a15013a45c9b55febc952bc905eed245ce0bb8d2
Copying blob sha256:27d26dfb2332cf1982c3a7ae05451b54a46776e2b0ec8d5afe5d93c3cd5075ed
...
Copying blob sha256:ead2c5851e51c822165ad2655efb2d37b1575423079539880b7de8abeee4a897
Copying blob sha256:744073494f37a3d2c835acc06b1621f3ac74bf9f358492efa8ce3e41678b4491
Copying blob sha256:a1c7d623d260d2a2bc94e2edee1c09391854fd0258c50bcaafde6b916cfdfaea
Copying blob sha256:4e6cf906bf73e4659b9a6a62b061303dff6ad3a0400e19f3c6f3252ab0dc4f45
Copying blob sha256:0bcbc76fa0b777aece71e6c5998215b689d3f370625ed86a9d354f6d0389e153
Copying config sha256:666a09e58ef7374faa69a18f258c984731816fcb28060b74c498a01ae60d6bed
Writing manifest to image destination
e47001a593d7d3dc0532e8a1100b61e2170843aaedf26b75ab3bbb44d584a86d
plex_network_holder
plex
OK: plex (plex_network_holder plex)
PASS: docker/plex

----

Testing docker/smokeping
4b7cbcbac146923a8f09b926491e9d1c69d2b8dce2c9bc60017a38dafec1340b
Trying to pull lscr.io/linuxserver/smokeping:latest...
Getting image source signatures
Copying blob sha256:4d45176ffeacd142e8b01f2f39824d529c1588cc02e2e14e4055426208228629
Copying blob sha256:f6a4c3e338ed76d3e90c1ce7a15013a45c9b55febc952bc905eed245ce0bb8d2
Copying blob sha256:04f7f3d843ff6ad309694c16fe8ba310d13907ea2a9bc97cc48626e353942458
Copying blob sha256:1f86bb998c1dc4c632f8f1320e75d0c81ffd318337e8e1d05044c5b4acf91a67
Copying blob sha256:29f93d2e5205edb2a53f6e95c8deee37d2144ab587b0c8bb7f9b8903745f55e0
Copying blob sha256:b9fc13fdb2d5eb2e902e3baf9301d18d4f0fbb7f1548b576ab64981520eae9af
Copying blob sha256:401c5b25effed4fb80cfe45779c810fb042d0f5cb5842593c439898b2c3bb602
Copying blob sha256:dc8b9e5167be55839804a60f5a5a544a5d66270f8cbb0c39166b0f2aa5d2cf8c
Copying blob sha256:d473e9e11b4984c172c906c5f979d85caa58f952db352877c525309b636f8aaa
Copying config sha256:302df7796701c0043f40659ec91ccd628e57283c0d10a6df9e8d9cb2b195eafc
Writing manifest to image destination
397bb18af30305fa1bfd90d1e8913ab46d47f47e0a824b9b99e7b9711ca79ca7
smokeping
OK: smokeping (smokeping)
PASS: docker/smokeping

----

Testing docker/syncthing
1977f30fa8ad08eb1416776c58f962290ff47d07eaa86c7bdd25f4ddf2d8955f
Trying to pull lscr.io/linuxserver/syncthing:latest...
Getting image source signatures
Copying blob sha256:4d45176ffeacd142e8b01f2f39824d529c1588cc02e2e14e4055426208228629
Copying blob sha256:f6a4c3e338ed76d3e90c1ce7a15013a45c9b55febc952bc905eed245ce0bb8d2
Copying blob sha256:1f86bb998c1dc4c632f8f1320e75d0c81ffd318337e8e1d05044c5b4acf91a67
...
Copying blob sha256:29f93d2e5205edb2a53f6e95c8deee37d2144ab587b0c8bb7f9b8903745f55e0
Copying blob sha256:401c5b25effed4fb80cfe45779c810fb042d0f5cb5842593c439898b2c3bb602
Copying blob sha256:067dd13bbbb31d119560d34da090e6b30bc56ffe07dd79ce2ff787f43da5efb1
Copying blob sha256:264ac161edd3af49f0708162144deb316ad02a1c2843232a9a284a71f71d4655
Copying blob sha256:313ad626bd459561d3b2e0657a7bf121879d595e6aba82bd1a98a8fe6bafd1c8
Copying config sha256:f3da59ec27b29514a104b2db5c9463f12d8d7f0946b27b7b0983334d8b2a16f2
Writing manifest to image destination
Error: statfs /path/to/data2: no such file or directory
Error: no container with name or ID "syncthing" found: no such container
FAIL(125): docker/syncthing

----

Testing docker/tailscale/caddy

caddy_network_holder
ts-caddy
caddy-reverse-proxy
OK: caddy (caddy_network_holder ts-caddy caddy-reverse-proxy)
PASS: docker/tailscale/caddy

----

Testing docker/tautulli
25db6cb94390a38b0306ab976ac1fdcda426e63b14e1b7f824651eab3f43a546
Trying to pull ghcr.io/tautulli/tautulli:latest...
Getting image source signatures
Copying blob sha256:1c64a44230e83e1172acaa57509786213d58d16cf0a2112e4c924ab5f6828e88
Copying blob sha256:245f048c9f8a2432538751286248ab017d49f67a6bc8b70db1a05a20c562ec6f
Copying blob sha256:b4a6013a75d147904664f2f911837e64b9e25586c4085e3fdbe176719c7f5687
Copying blob sha256:6e909acdb790c5a1989d9cfc795fda5a246ad6664bb27b5c688e2b734b2c5fad
Copying blob sha256:9eab895eb84c23106b53e9b3eaa76d790aa11ad723bc8d8e429785e790e5630d
Copying blob sha256:18dfef5bd895f1188a566fe3ab02fb31fc0b6da9d2b0720d66a14449fa57dfa0
Copying blob sha256:29fdab7994971bdbe0740f8dd1eaac75d8320a4a9e154376206c2e28467498aa
Copying blob sha256:183017892fa12b245189e9aaf3047fee77f7e85d8dbd1110c79b671700fda9ee
Copying blob sha256:5992ebb42f1d1e893ba983cdaf36536031819e10b6ab3090bd9e394e6ae76257
Copying blob sha256:8e24b83c3505e475674c0eb231458040c3755e50772ec3673a2cf68f8f3aeadd
Copying config sha256:1b1fd32fc9f7c77e7ba3678cfba39126991f296332580ccaad3838972c27120d
Writing manifest to image destination
bafdb1f4beef363db9998ba8b3a96e6b28a75ed055a1712820f9113e459d7c07
tautulli
OK: tautulli (tautulli)
PASS: docker/tautulli

----

Testing docker/tdarr/igp
30b79c4c3ef422fbdbf630201dd726503914dad0160adb00b6167b24dfdb95e8
Trying to pull ghcr.io/haveagitgat/tdarr_node:latest...
Getting image source signatures
Copying blob sha256:9fe595fb924b775ab1d63076961c17dfd97b328a15dda61e0211cceebd31ff6e
Copying blob sha256:f6a4c3e338ed76d3e90c1ce7a15013a45c9b55febc952bc905eed245ce0bb8d2
Copying blob sha256:1aae86535fce6d6e1d8f05d93be861b1e397fab77a3e40eaa94b2f591cd00782
Copying blob sha256:33fc46fd857f7b38ab0c4a8f646c4f297d43eb3e6a356575502969ad4fb3c2ad
Copying blob sha256:ad90a9ea06268b68cd04e15b2190117bab4a20f7c61b367a820533548599f84a
Copying blob sha256:d1ff89277d852217e74319ee72e0698d28e4e32314a2661c39db0ac1a48b3691
Copying blob sha256:572a2e003e11bb65ac72f7a0e8a763162c97dd0fb4561a2e26051698276fdc1b
Copying blob sha256:a76358033acd20a0634d43d918d6170f6a824208baf868776606c94912ecf640
Copying blob sha256:7241047f3506f34cdbef08d26cd1f7ae61d59ba588208cf412bc64c3a1914e28
Copying blob sha256:751a2e81eaae84fd56e8ed984da4ea394251084941c296509f307ddf4979658c
Copying blob sha256:821eb3be17f050b952bc5044227c91abc23f01e89ab597742f04a008bfec09db
Copying blob sha256:54e06c3734eea3cb51b942c2c022b5b74101d3610f093b4f3a29699ea05ea157
Copying blob sha256:18eed1682ce9ddc0f1eabc4b8efc138640053f49e99e83048cd19134cc018448
Copying config sha256:5bdc2b519e338c50e101af869bed0848726c11c8b7c2bd8c85ff68dd8fc6a3ce
Writing manifest to image destination
f09654122d053b1bf4c615bd90e7df98deb08bff1c17324d75beef7266115d59
tdarr-node
OK: igp (tdarr-node)
PASS: docker/tdarr/igp

----

Testing docker/uptime-kuma
1bb0bb52e98040e1b19e5a3b53d7fe989572c2e0bfbd858b6803aad0910ee473
Trying to pull docker.io/louislam/uptime-kuma:1...
time="2026-01-21T17:21:31+08:00" level=warning msg="Failed, retrying in 1s ... (1/3). Error: copying system image from manifest list: determining manifest MIME type for docker://louislam/uptime-kuma:1: reading manifest sha256:0f6c88f1e5f98146dcc2ca8408d2982e2d25db968be14ff718e10a59c9a84938 in docker.io/louislam/uptime-kuma: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:22:07+08:00" level=warning msg="Failed, retrying in 1s ... (2/3). Error: initializing source docker://louislam/uptime-kuma:1: reading manifest 1 in docker.io/louislam/uptime-kuma: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:23:17+08:00" level=warning msg="Failed, retrying in 1s ... (3/3). Error: copying system image from manifest list: determining manifest MIME type for docker://louislam/uptime-kuma:1: reading manifest sha256:0f6c88f1e5f98146dcc2ca8408d2982e2d25db968be14ff718e10a59c9a84938 in docker.io/louislam/uptime-kuma: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
Error: unable to copy from source docker://louislam/uptime-kuma:1: initializing source docker://louislam/uptime-kuma:1: reading manifest 1 in docker.io/louislam/uptime-kuma: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit
...
c380c35df4cdad2fd1ec03dc419438bad8356d09cedee5b0e1e5bf3ef85a6c4a
Trying to pull docker.io/library/mariadb:10.3...
time="2026-01-21T17:24:30+08:00" level=warning msg="Failed, retrying in 1s ... (1/3). Error: initializing source docker://mariadb:10.3: reading manifest 10.3 in docker.io/library/mariadb: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
Testing docker/youtarr
Trying to pull docker.io/library/mariadb:10.3...
time="2026-01-21T17:25:40+08:00" level=warning msg="Failed, retrying in 1s ... (2/3). Error: copying system image from manifest list: determining manifest MIME type for docker://mariadb:10.3: reading manifest sha256:a4b57b620852e26f2c306c79fd8a61e22c7cd6e55d0a55d5521854ed2c370102 in docker.io/library/mariadb: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:26:01+08:00" level=warning msg="Failed, retrying in 1s ... (1/3). Error: initializing source docker://mariadb:10.3: reading manifest 10.3 in docker.io/library/mariadb: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:26:17+08:00" level=warning msg="Failed, retrying in 1s ... (3/3). Error: initializing source docker://mariadb:10.3: reading manifest 10.3 in docker.io/library/mariadb: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:26:38+08:00" level=warning msg="Failed, retrying in 1s ... (2/3). Error: initializing source docker://mariadb:10.3: reading manifest 10.3 in docker.io/library/mariadb: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
Error: unable to copy from source docker://mariadb:10.3: initializing source docker://mariadb:10.3: Get "https://registry-1.docker.io/v2/library/mariadb/manifests/10.3": dial tcp: lookup registry-1.docker.io: Temporary failure in name resolution
Trying to pull docker.io/dialmaster/youtarr:latest...
time="2026-01-21T17:27:53+08:00" level=warning msg="Failed, retrying in 1s ... (1/3). Error: copying system image from manifest list: determining manifest MIME type for docker://dialmaster/youtarr:latest: reading manifest sha256:6752636fc2c762ec852aa5fd9babafd2ab3519dd818b6e32065c23e414f32fd1 in docker.io/dialmaster/youtarr: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
FAIL(124): docker/youtarr

----


## Retest: 2026-01-21T17:34:28+08:00

Testing docker/graylog
03fefabcfa5b81a8665f49eaf97ff32725efabf3e5aa176a32391a386bd416bc
...
Writing manifest to image destination
3b08a995936079e1d7d92a1edeea71a54fed59994501987d082428fead51a44c
Trying to pull docker.io/graylog/graylog-datanode:6.1...
time="2026-01-21T17:35:15+08:00" level=warning msg="Failed, retrying in 1s ... (1/3). Error: copying system image from manifest list: determining manifest MIME type for docker://graylog/graylog-datanode:6.1: reading manifest sha256:07abddaeb4040705255e601bc0bec2067536a96ddf379c80bfe18f582be85fe2 in docker.io/graylog/graylog-datanode: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:35:52+08:00" level=warning msg="Failed, retrying in 1s ... (2/3). Error: initializing source docker://graylog/graylog-datanode:6.1: reading manifest 6.1 in docker.io/graylog/graylog-datanode: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:37:02+08:00" level=warning msg="Failed, retrying in 1s ... (3/3). Error: copying system image from manifest list: determining manifest MIME type for docker://graylog/graylog-datanode:6.1: reading manifest sha256:07abddaeb4040705255e601bc0bec2067536a96ddf379c80bfe18f582be85fe2 in docker.io/graylog/graylog-datanode: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
FAIL(124): docker/graylog

----

Testing docker/inotify/sender_unraid
/home/abl030/nixosconfig/scripts/podman-stack-test.sh: line 147: /home/abl030/.podman-test-mounts/sender_unraid/unraid/appdata/inotify-bridge/sender.sh: Is a directory
FAIL(1): docker/inotify/sender_unraid
...
Error: no container with name or ID "firefly_iii_cron" found: no such container
firefly_iii_redis
time="2026-01-21T17:37:39+08:00" level=warning msg="StopSignal SIGTERM failed to stop container docspell-consumedir in 10 seconds, resorting to SIGKILL"
docspell-consumedir
ts-invoices
docspell-solr
time="2026-01-21T17:37:49+08:00" level=warning msg="StopSignal SIGTERM failed to stop container docspell-joex in 10 seconds, resorting to SIGKILL"
docspell-joex
docspell-restserver
firefly_iii_db
caddy-invoices
time="2026-01-21T17:38:00+08:00" level=warning msg="StopSignal SIGQUIT failed to stop container firefly_iii_core in 10 seconds, resorting to SIGKILL"
firefly_iii_core
postgres_db
invoices_network_holder
time="2026-01-21T17:38:10+08:00" level=warning msg="StopSignal SIGQUIT failed to stop container firefly_iii_importer in 10 seconds, resorting to SIGKILL"
firefly_iii_importer
caddy-invoices
Error: no container with ID or name "firefly_iii_cron" found: no such container
firefly_iii_importer
docspell-consumedir
firefly_iii_core
docspell-joex
...
c94fc87ac08c9ee21ef7e61f510c5ac9066364ffee4414585d26d1c6b8539f82
invoices_default

Trying to pull docker.io/library/alpine:3.20...
time="2026-01-21T17:39:21+08:00" level=warning msg="Failed, retrying in 1s ... (1/3). Error: copying system image from manifest list: determining manifest MIME type for docker://alpine:3.20: reading manifest sha256:008827ed2172a676b08121e21cf9db0ce08a90ee6c8a12fc374af8a56c0e496d in docker.io/library/alpine: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:39:58+08:00" level=warning msg="Failed, retrying in 1s ... (2/3). Error: initializing source docker://alpine:3.20: reading manifest 3.20 in docker.io/library/alpine: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
FAIL(124): docker/invoices

----

Testing docker/jellyfinn
16c3169407fbbd258bf7a28b34ff91e8d2c28b671dad83cd923133114833c9f6
7a2c8c52f1725f201e27202bb3d5bf429c3bf43ff318d1c34ebb9685bd099ff4
Trying to pull docker.io/library/postgres:15.2...
Error: unable to copy from source docker://postgres:15.2: initializing source docker://postgres:15.2: pinging container registry registry-1.docker.io: Get "https://registry-1.docker.io/v2/": dial tcp: lookup registry-1.docker.io: Temporary failure in name resolution
Trying to pull lscr.io/linuxserver/jellyfin:latest...
Getting image source signatures
Copying blob sha256:5eb77ae989566994a643724e14bc017f2be93635fad43385738c0bbbad3fb61d
Copying blob sha256:f6a4c3e338ed76d3e90c1ce7a15013a45c9b55febc952bc905eed245ce0bb8d2
...
Copying config sha256:1891ee77e8af5d18d2b6218ae79899515c98113798faabfbc9214fd5fdf1b4cf
Writing manifest to image destination
22ad35be1a980787e47d6fcc461216885fb12182bc43892959a5a8d70fdee588
5ee5dd3609c4429172e25ef51d925ce96a0ec6245a49c4037964a5e8adfbfbf9
ac58c943ac71222b11165c13c9395266616486f851c950505d6468c0563aaca8
Trying to pull ghcr.io/arabcoders/watchstate:latest...
Getting image source signatures
Copying blob sha256:00dc600ccc850e4c7563da1a98cf8784ddb9baf2e8bbe14824c00689370c107b
Copying blob sha256:0d37574009de1199f8af575fda053811db541f01a97d948179bf609d8e03d009
...
Copying config sha256:81b0890041c41b1f9ff2cdd52833d99de341d5e0a16e544565dcb1684a987001
Writing manifest to image destination
f37730d8c7c6134b0641667eaf6a090c5d5f1550b3b4a005158455ba2d0e240f
Trying to pull docker.io/gotify/server:latest...
...
Testing docker/management/epi_management
5f525163bb22c77a90e55fbcbf74d8273543e68dd08e58968dbf34559361b2ac
Trying to pull docker.io/willfarrell/autoheal:latest...
time="2026-01-21T17:47:06+08:00" level=warning msg="Failed, retrying in 1s ... (1/3). Error: initializing source docker://willfarrell/autoheal:latest: reading manifest latest in docker.io/willfarrell/autoheal: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:47:42+08:00" level=warning msg="Failed, retrying in 1s ... (2/3). Error: initializing source docker://willfarrell/autoheal:latest: reading manifest latest in docker.io/willfarrell/autoheal: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:48:27+08:00" level=warning msg="Failed, retrying in 1s ... (3/3). Error: copying system image from manifest list: determining manifest MIME type for docker://willfarrell/autoheal:latest: reading manifest sha256:69edb1bc3bd3cc862f06af9461c5a3a16a10237c88abd01e893c3dff6c04a187 in docker.io/willfarrell/autoheal: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
...
12c43b8ab225666e39a642873c5c4d9d1de96d069c88bd0b9b3f964915032373
Error: no container with name or ID "autoheal" found: no such container
dozzle-agent
FAIL(125): docker/management/epi_management

----

Testing docker/management/igpu
6bbdf7cc54f5d4989f5a5a10e2c76c7e9ba07ab375a47540f741c53f86f5b108
Trying to pull docker.io/willfarrell/autoheal:latest...
time="2026-01-21T17:49:41+08:00" level=warning msg="Failed, retrying in 1s ... (1/3). Error: initializing source docker://willfarrell/autoheal:latest: reading manifest latest in docker.io/willfarrell/autoheal: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
Testing docker/inotify/sender_unraid
293ef4eb64b9784aaf5fa75c94cdef24548a049581b49d63b9042cb8d48c95eb
Trying to pull docker.io/devodev/inotify:0.3.0...
time="2026-01-21T17:50:51+08:00" level=warning msg="Failed, retrying in 1s ... (2/3). Error: copying system image from manifest list: determining manifest MIME type for docker://willfarrell/autoheal:latest: reading manifest sha256:69edb1bc3bd3cc862f06af9461c5a3a16a10237c88abd01e893c3dff6c04a187 in docker.io/willfarrell/autoheal: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:51:08+08:00" level=warning msg="Failed, retrying in 1s ... (1/3). Error: initializing source docker://devodev/inotify:0.3.0: reading manifest 0.3.0 in docker.io/devodev/inotify: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:51:27+08:00" level=warning msg="Failed, retrying in 1s ... (3/3). Error: initializing source docker://willfarrell/autoheal:latest: reading manifest latest in docker.io/willfarrell/autoheal: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:51:45+08:00" level=warning msg="Failed, retrying in 1s ... (2/3). Error: initializing source docker://devodev/inotify:0.3.0: reading manifest 0.3.0 in docker.io/devodev/inotify: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
Error: unable to copy from source docker://willfarrell/autoheal:latest: initializing source docker://willfarrell/autoheal:latest: reading manifest latest in docker.io/willfarrell/autoheal: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit
982a6aadb43124b36e144d7474c86357d7ecec30e5ab9f614a73187b5d34347b
Error: no container with name or ID "autoheal" found: no such container
dozzle-agent
time="2026-01-21T17:52:21+08:00" level=warning msg="Failed, retrying in 1s ... (3/3). Error: initializing source docker://devodev/inotify:0.3.0: reading manifest 0.3.0 in docker.io/devodev/inotify: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
Error: unable to copy from source docker://devodev/inotify:0.3.0: copying system image from manifest list: determining manifest MIME type for docker://devodev/inotify:0.3.0: reading manifest sha256:1131c1a5cae132c30415dde6283ea9453b83caae3be8d6cc5cadb23309d2b0a3 in docker.io/devodev/inotify: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit
Trying to pull docker.io/willfarrell/autoheal:latest...
FAIL(124): docker/inotify/sender_unraid

----

Testing docker/management/igpu
Trying to pull docker.io/willfarrell/autoheal:latest...
time="2026-01-21T17:54:23+08:00" level=warning msg="Failed, retrying in 1s ... (1/3). Error: initializing source docker://willfarrell/autoheal:latest: reading manifest latest in docker.io/willfarrell/autoheal: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:55:34+08:00" level=warning msg="Failed, retrying in 1s ... (2/3). Error: copying system image from manifest list: determining manifest MIME type for docker://willfarrell/autoheal:latest: reading manifest sha256:69edb1bc3bd3cc862f06af9461c5a3a16a10237c88abd01e893c3dff6c04a187 in docker.io/willfarrell/autoheal: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
time="2026-01-21T17:56:11+08:00" level=warning msg="Failed, retrying in 1s ... (3/3). Error: initializing source docker://willfarrell/autoheal:latest: reading manifest latest in docker.io/willfarrell/autoheal: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit"
Error: unable to copy from source docker://willfarrell/autoheal:latest: initializing source docker://willfarrell/autoheal:latest: reading manifest latest in docker.io/willfarrell/autoheal: toomanyrequests: You have reached your unauthenticated pull rate limit. https://www.docker.com/increase-rate-limit
61be1fc7e983be2d4d2713bae16099f28a217d954814ab8022665b5a57720346
Error: no container with name or ID "autoheal" found: no such container
dozzle-agent
...
Testing docker/openobserve
98fedb172abf44355cf449ec58b121df56171828b7affaf7753cba2ce297f1d2
Trying to pull public.ecr.aws/zinclabs/openobserve:latest-simd...
Getting image source signatures
Copying blob sha256:d557676654e572af3e3173c90e7874644207fda32cd87e9d3d66b5d7b98a7b21
Copying blob sha256:5b3013706a463509f05fabda3a5f854b1c5f3429561cf9374db6e6681da5493f
...
Copying config sha256:3c6360964da09520e51348e6bfe89ffd13f2228b76ac9ddf28ffc14716889f80
Writing manifest to image destination
a3fe6d2811f474749bffccdcd28fd1d307f9cd5658b83eabf48bec23abb52422
openobserve
OK: openobserve (openobserve)
PASS: docker/openobserve
...
Traceback (most recent call last):
  ...
  File "/nix/store/l4svg7s9n7f3zzlfc05bv10bc67lrb07-podman-compose-1.5.0/lib/python3.13/site-packages/podman_compose.py", line 2070, in run
    self._parse_compose_file()
    ~~~~~~~~~~~~~~~~~~~~~~~~^^
  File "/nix/store/l4svg7s9n7f3zzlfc05bv10bc67lrb07-podman-compose-1.5.0/lib/python3.13/site-packages/podman_compose.py", line 2442, in _parse_compose_file
    raise RuntimeError(f"volume [{vol_name}] not defined in top level")
RuntimeError: volume [${DATA_ROOT/syncthing/data}] not defined in top level
FAIL(1): docker/syncthing

----

Testing docker/syncthing
2fb17a3f00acc4266083d6017dfec7377bc8f36ab95260e132c433e30459da96
2e8082980db60765583724e57a3ec0be5688d0c4686c9d3b7d6aa1d8772774e1
syncthing
OK: syncthing (syncthing)
PASS: docker/syncthing
