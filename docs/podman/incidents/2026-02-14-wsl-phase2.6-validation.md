...
1. Residual risks above are accepted for current homelab operations.
2. Monitoring/health checks are treated as authoritative for runtime failure detection.
3. Standard rebuild workflow with Home Manager activation is relied on to keep drift risk low in practice.
