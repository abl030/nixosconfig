          ...
          in
            pkgs.runCommand "cullen-bd-proxy" {} ''
              ...
              case ${lib.escapeShellArg bdVhost.locations."/".extraConfig} in
                *'proxy_ssl_server_name on;'*'proxy_ssl_name bd.ablz.au;'*'proxy_ssl_verify on;'*'proxy_ssl_trusted_certificate /etc/ssl/certs/ca-bundle.crt;'*'proxy_set_header Host bd.ablz.au;'*) ;;
