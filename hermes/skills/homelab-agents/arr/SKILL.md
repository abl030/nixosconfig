...
metadata:
  hermes:
    ...
    source: /home/abl030/nixosconfig/.claude/agents/arr.md
---

# arr

Migrated from `nixosconfig/.claude/agents/arr.md` so this homelab agent prompt is tracked in git and usable by Hermes.
